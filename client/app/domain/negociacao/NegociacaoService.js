        ...
        execute: function () {
            class NegociacaoService {
                ...
                obtemNegociacoesdoPeriodo() {
                    return Promise.all([this.obterNegociacoesDaSemana(), this.obterNegociacoesDaSemanaAnterior(), this.obterNegociacoesDaSemanaRetrasada()]).then(periodo => periodo.reduce((novoArray, item) => novoArray.concat(item), []).sort((a, b) => a.data.getTime() - b.data.getTime())).catch(err => {
